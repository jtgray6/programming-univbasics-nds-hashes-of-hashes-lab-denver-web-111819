...
def naming_system
  ...
  {PORTION_1[:label],PORTION_1[:sub_category][:label],PORTION_1[:sub_category][:sub_category][:label],PORTION_2[:label],PORTION_3[:label],PORTION_3[:sub_category][:label],PORTION_4[:label]}
end
